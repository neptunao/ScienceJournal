...
#articles
ar = Article.create!(title: 'test', data_files: data_files, author_ids: [author1.id], category_id: root.id)
ar1 = Article.new(title: 'test_reviewed', author_ids: [author1.id], status: Article::STATUS_REVIEWED, category_id: child1.id)
...
#journals
Journal.create(name: 'Journal', num: 1, category_id: root.id, article_ids: [ar.id],
               data_files: [DataFile.create(filename: '22test22', tag: Journal::JOURNAL_FILE_TAG)])
Journal.create(name: 'Journal', num: 2, category_id: root.id, article_ids: [ar.id],
